export function ServicesInfographicDe() {
  return (
    <svg
      ...
      aria-label="Überblick unserer Elektroplanungsleistungen"
    >
      {/* Original PNG — unmodified */}
      ...
      {/* ── Left label 1: Individuelle Beratung ── */}
      ...
      {/* ── Left label 2: Beleuchtungslösungen ── */}
      <rect x="0" y="228" width="258" height="48" fill="white" />
      <text x="252" y="258" textAnchor="end" fontSize="22" fill="#333" fontFamily="'Segoe UI',system-ui,sans-serif">Beleuchtungslösungen</text>

      {/* ── Left label 3: Stromzähleranlagen ── */}
      <rect x="0" y="354" width="258" height="62" fill="white" />
      <text x="252" y="378" textAnchor="end" fontSize="24" fill="#333" fontFamily="'Segoe UI',system-ui,sans-serif">Stromzähler-</text>
      <text x="252" y="408" textAnchor="end" fontSize="24" fill="#333" fontFamily="'Segoe UI',system-ui,sans-serif">anlagen</text>

      {/* ── Left label 4: Temperatursteuerung ── */}
      <rect x="0" y="476" width="258" height="68" fill="white" />
      ...
      {/* ── Right label 1: Planung von Steckdosen und Schaltern ── */}
      <rect x="684" y="88" width="256" height="120" fill="white" />
      ...
      {/* ── Right label 2: Badlüftung ── */}
      <rect x="684" y="226" width="256" height="50" fill="white" />
      <text x="690" y="258" textAnchor="start" fontSize="24" fill="#333" fontFamily="'Segoe UI',system-ui,sans-serif">Badlüftung</text>

      {/* ── Right label 3: Elektrischer Hausanschluss ── */}
      <rect x="684" y="346" width="256" height="76" fill="white" />
      <text x="690" y="372" textAnchor="start" fontSize="24" fill="#333" fontFamily="'Segoe UI',system-ui,sans-serif">Elektrischer</text>
      <text x="690" y="400" textAnchor="start" fontSize="24" fill="#333" fontFamily="'Segoe UI',system-ui,sans-serif">Hausanschluss</text>

      {/* ── Right label 4: Smart-Home-Automatisierung ── */}
      <rect x="684" y="474" width="256" height="70" fill="white" />
      <text x="690" y="498" textAnchor="start" fontSize="24" fill="#333" fontFamily="'Segoe UI',system-ui,sans-serif">Smart-Home-</text>
      <text x="690" y="526" textAnchor="start" fontSize="24" fill="#333" fontFamily="'Segoe UI',system-ui,sans-serif">Automatisierung</text>
    </svg>
  );
}
