/* Deutsche Version der Infografik — überlagert deutsche Texte direkt auf dem
   ...
   der Hintergrundfarbe der Sektion (#D9EAEC) statt Weiß, damit sie nicht
   als sichtbare Kästen auf dem Hintergrund abstechen. */
export function ServicesInfographicDe() {
  return (
    ...
    >
      ...
      {/* ── Titel überdecken ── */}
      <rect x="110" y="4" width="720" height="42" fill="#D9EAEC" />
      ...
      <rect x="0" y="104" width="258" height="78" fill="#D9EAEC" />
      ...
      <rect x="0" y="460" width="258" height="125" fill="#D9EAEC" />
      ...
      <rect x="684" y="80" width="256" height="150" fill="#D9EAEC" />
      ...
      {/* ── Rechts 2: Badlüftung ── */}
      <rect x="684" y="214" width="256" height="100" fill="#D9EAEC" />
      ...
      <rect x="684" y="334" width="256" height="118" fill="#D9EAEC" />
      ...
      <rect x="684" y="458" width="256" height="127" fill="#D9EAEC" />
