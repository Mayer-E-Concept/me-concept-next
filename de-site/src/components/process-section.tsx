...
const STEPS: Step[] = [
  {
    title: "Erstberatung",
    desc: "Wir besprechen Anforderungen, Fristen und technische Spezifikationen. Unverbindlich, ohne versteckte Kosten.",
    icon: <IconConsult />,
  },
  {
    title: "Technische Planung",
    desc: "Vollständige Dokumentation in BIM Revit gemäß VDE-Vorschriften und geltenden Normen.",
    icon: <IconDesign />,
  },
  {
    title: "Prüfung & Freigabe",
    desc: "Projekt geprüft von einem zertifizierten Prüfer, genehmigungsfertig für Ausführung.",
    icon: <IconVerify />,
  },
  {
    title: "Dokumentationsübergabe",
    desc: "Vollständiger Plansatz, Berichte und Berechnungen — strukturiert für den Auftragnehmer.",
    icon: <IconDeliver />,
  },
];

export function ProcessSectionDe() {
  return (
    <section
      style={{
        position: "relative",
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "clamp(48px, 6vw, 72px)" }}>
          ...
          >
            Vom ersten Gespräch bis zur fertigen Dokumentation — ein transparenter Prozess ohne Überraschungen.
          </p>
        </div>
