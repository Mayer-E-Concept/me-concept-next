...
const LEFT: Item[] = [
  { label: "Individuelle Beratung", icon: MessageSquare, y: 46, bulbX: 326, bulbY: 176 },
  { label: "Beleuchtungslösungen", icon: Lightbulb, y: 175, bulbX: 300, bulbY: 205 },
  { label: "Stromzähler", icon: Gauge, y: 285, bulbX: 300, bulbY: 247 },
  { label: "Temperatursteuerung", icon: Thermometer, y: 414, bulbX: 326, bulbY: 276 },
];

const RIGHT: Item[] = [
  { label: "Steckdosen und Schalter", icon: ToggleLeft, y: 46, bulbX: 374, bulbY: 176 },
  { label: "Badlüftung", icon: Fan, y: 175, bulbX: 400, bulbY: 205 },
  { label: "Hausanschluss", icon: Cable, y: 285, bulbX: 400, bulbY: 247 },
  { label: "Smart-Home-Automation", icon: Smartphone, y: 414, bulbX: 374, bulbY: 276 },
];
