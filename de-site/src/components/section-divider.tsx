...
export function SectionDivider({ position = "top" }: { position?: "top" | "bottom" }) {
  return (
    <div
      aria-hidden
      style={{
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 5, margin: "0 10px", flexShrink: 0 }}>
        <span style={{ width: 7, height: 7, background: "#C5895B", opacity: 0.7, transform: "rotate(45deg)", display: "block" }} />
        <span style={{ width: 10, height: 10, background: "#C5895B", opacity: 0.9, transform: "rotate(45deg)", display: "block" }} />
        <span style={{ width: 7, height: 7, background: "#C5895B", opacity: 0.7, transform: "rotate(45deg)", display: "block" }} />
      </div>
      <div
        style={{
